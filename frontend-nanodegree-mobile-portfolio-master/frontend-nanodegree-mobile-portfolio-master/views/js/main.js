...
var resizePizzas = function(size) {
    ...
    function changeSliderLabel(size) {
        var x = document.getElementById("pizzaSize");
        // we store the value of document.querySelector("#pizzaSize") in a variable called x, to avoid repeatation.
        switch (size) {
    ...
    //here,we make the changes in the given code.
    //we make a less complex code and reduce the response time when we resizes the pizza.
    //it was earlier more than 100ms and now is less than 2ms.
    // we here stop the FSL occuring and with variable randomPizzas we stop the repeatation of  document.querySelectorAll(".randomPizzaContainer").
...
var pizzasDiv = document.getElementById("randomPizzas"); //I move out this line from the for loop. 
for (var i = 2; i < 100; i++) {
...
function updatePositions() {
    ...
    var st=document.body.scrollTop;// i have saved the value in a variable.
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var y = document.getElementById("movingPizzas1");
    //we take  a variable named y here to store the value of document.querySelector("#movingPizzas1"),so that each time in for loop we simply append in y.
    for (var i = 0; i < 40 ; i++) {
