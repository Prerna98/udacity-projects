...
$(function() {
    ...
    describe("New Feed Selection", function() {
        ...
        it(" they both should not be equal ", function(done) {
            expect(l2).not.toEqual(l1); //new should not be equal to old
            done();
        });
    });
});